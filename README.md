...
**Reference beam (used consistently across all nine modules):** simply supported RC beam, clear span L = 9 m, cross-section b x h = 250 x 600 mm, 3 tension bars of 20 mm diameter (As = 942.5 mm^2), effective depth d ≈ 560 mm, C30/37 concrete, B500 steel, cover 30 mm, characteristic dead load gk = 6 kN/m, characteristic live load qk = 6 kN/m (following the deterministic design reported by Al-Mosawe et al., 2024, with adjustments).
...
| `06_cost_sensitivity_analysis.py` | Discount-rate (1-10%) and severity-exponent (0.1-1.0) one-at-a-time sensitivity sweeps | Results 4.4.3 |
...
python 06_cost_sensitivity_analysis.py         # very expensive: ~15-30 min (19 re-runs of Module 5)
...
wilbert.yaury@etudiant.univ-lr.fr
